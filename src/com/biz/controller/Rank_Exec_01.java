...
public class Rank_Exec_01 {
	public static void main(String[] args) {
		 ...
		 * 세팅된 배열의 값을 오름차순 정렬을 해보자
		 */
		int[] intKor = new int[10];
		Random rnd = new Random();
		
		//Random(난수)를 발생하여 51~100까지 임의값으로 채우기
		 ...
		 * 
		 * 하지만 컴퓨터에서 생성하는 난수는 컴퓨터 내부에서 특별한 연산을 통해 생성을 하다보니
		 * 유사한 값들이 나타난다.
		 * 그래서 컴퓨터에서 생성한 난수는 유사난수 라고 부르며 실험적인 용도로만 사용해야 한다.
		 * 
		 */
