...
public class Score_Exec_06 {
	...
	public static void main(String[] args) {
		...
		/*
		 * List의 크기를 알 수 있는 method 로 List.size()가 있다
		 * 이 List.size() method는 호출할때마다 매번 List의 개수를 계산한다.
		 * 따라서 배열의 length와는 성질이 달라서
		 * for문 내에서 가급적 사용하지 말고
		 * for가 시작되기전에 미리 변수에 저장하고 for 반복문을 실행하는 것이 좋다
		 */
