...
public class ScoreVO {
	 ...
	 *  getter와 setter method를 생성해서 사용한다,
	 *  == 데이터를 은닉해서 데이터를 보호하는 목적
	 *  3. toString() method를 재정의(override)해서
	...
	//toString()은 원래 Object 크래스에 정의되어 있는 method이며
	//객체가 저장된 메모리 주소를 알려주는 method이며
	//이method를 각 필드의 값을 확인시켜주는 용도로 변경
	@Override
